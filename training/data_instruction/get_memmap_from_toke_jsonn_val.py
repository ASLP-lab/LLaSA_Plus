...
def process_data(transcriptions, speech_path_mapper, output_dir_tts, num_processes=4):
    ...
    train_tts_memmap_path = os.path.join(output_dir_tts, 'val_input_ids.memmap')
    ...
    np.save(os.path.join(output_dir_tts, 'val_input_ids_shape.npy'), train_tts_input_ids_array.shape)
...
if __name__ == "__main__":
    ...
    json_files_tts = [
        ...
        '/user-fs/zhuxinfa/dataset/text2speech/libritts_test_clean.jsonl'
    ]
    merged_data = []
